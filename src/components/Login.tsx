        ...
        <div className="hero border-solid flex-grow flex flex-row items-center">
          <div className="left-hero w-[40%] h-full  px-[100px] flex flex-col justify-center">
            <div className="form-header flex flex-col items-center justify-center">
              <span className="font-bold text-[43px] text-[#29D1B8]">GET STARTED <span className="text-[#37439E] font-bold">NOW!</span></span>
              <span className="text-[16px] font-bold">Sign Up to create an account.</span>
            </div>
            ...
            <div className="btn-container">
                <div className="my-[10px]">
                    <input className="cursor-pointer mx-[8px]" type="checkbox" name="check-pass" id="check-pass" />
                    <label className="cursor-pointer text-[#94A1B2]" htmlFor="check-pass">Show Password</label>
                </div>
               <input className="mt-[10 px] border-solid border-[1px] bg-[#37439E] w-full rounded-[10px] text-[#ffffff] h-[50px]" type="button" value="Sign-Up" />
            </div>
          </div>
